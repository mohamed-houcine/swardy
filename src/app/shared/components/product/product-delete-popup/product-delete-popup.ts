...
@Component({
  ...
  standalone: true,
  templateUrl: './product-delete-popup.html',
  styleUrls: ['./product-delete-popup.css']
})
export class ProductDeletePopup {
  constructor(
    private dialogRef: MatDialogRef<ProductDeletePopup>,
